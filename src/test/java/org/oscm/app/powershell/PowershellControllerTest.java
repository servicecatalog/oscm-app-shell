...
public class PowershellControllerTest {
    ...
    private PowershellController controller;
	...
	String batchFile = new File(PowershellControllerTest.class.getResource("/batch.ps1").getFile())
		.getAbsolutePath();
	controller = spy(new PowershellController());
