...
public class ScriptValidator {
  ...
  public Script validateIfScriptExists(String scriptPath) throws APPlatformException {
    ...
    try {
      Script script = Script.getInstance(scriptPath);
      script.initialize();
      return script;
    } catch (Exception e) {
      throw new APPlatformException(
          "Script: " + scriptPath + " cannot be loaded: " + e.getMessage());
    }
  }
  ...
  public void validateInteractiveCommands(Script script) throws APPlatformException {
    ...
    if (found) {
      ...
      throw new APPlatformException(
          "Script " + script.getScriptPath() + " contains an interactive command.");
    }
  }
