...
public class AppDatabaseClient {
    ...
    private HashMap<String, String> powershellSettings;
    private HashMap<String, String> appSettings;

    public String loadPowershellSetting(String key) throws Exception {
	if (powershellSettings == null) {
	    powershellSettings = loadControllerSettings(CONTROLLER_ID);
	}
	return powershellSettings.get(key);
    }
    ...
    public HashMap<String, String> loadPowershellSettings() throws Exception {
