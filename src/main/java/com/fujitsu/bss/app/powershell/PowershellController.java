...
import static com.fujitsu.bss.app.powershell.business.Configuration.CONTROLLER_ID;
...
import static com.fujitsu.bss.app.powershell.business.ConfigurationKey.OPERATIONS_ID;
import static com.fujitsu.bss.app.powershell.business.ConfigurationKey.OPERATIONS_SCRIPT;
import static com.fujitsu.bss.app.powershell.business.ConfigurationKey.PROVISIONING_SCRIPT;
import static com.fujitsu.bss.app.powershell.business.ConfigurationKey.REQUESTING_USER_ID;
...
import static com.fujitsu.bss.app.powershell.business.ConfigurationKey.SM_STATE;
import static com.fujitsu.bss.app.powershell.business.ConfigurationKey.SM_STATE_HISTORY;
import static com.fujitsu.bss.app.powershell.business.ConfigurationKey.UPDATE_SCRIPT;
import static com.fujitsu.bss.app.powershell.business.ConfigurationKey.UPDATE_USER_SCRIPT;
import static com.fujitsu.bss.app.powershell.business.ConfigurationKey.USER_COUNT;
import static com.fujitsu.bss.app.powershell.business.ConfigurationKey.VERIFICATION_SCRIPT;
import static com.fujitsu.bss.app.powershell.business.ConfigurationKey.VERIFICATION_TIMEOUT;
import static com.fujitsu.bss.app.powershell.business.api.Powershell.VERIFICATION_MESSAGE;
...
import com.fujitsu.bss.app.powershell.business.ConfigurationKey;
import com.fujitsu.bss.app.powershell.business.PowershellControllerAccess;
import com.fujitsu.bss.app.powershell.business.Script;
import com.fujitsu.bss.app.powershell.business.api.Powershell;
import com.fujitsu.bss.app.powershell.business.api.PowershellCommand;
import com.fujitsu.bss.app.powershell.business.api.PowershellPool;
import com.fujitsu.bss.app.powershell.business.api.PowershellStatus;
